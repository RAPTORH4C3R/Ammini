...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'AMMINI public bot' : process.env.ALL_CAPTION,
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? 'AMMINI MWOL' : process.env.BOT_NAME,
    ...
    RAPTOR: process.env.LOGO_LINK === undefined ? 'https://i.ibb.co/9rrnJ7g/20210815-080839.jpg' : process.env.LOGO_LINK,
    ...
    TAGPLK: process.env.TAG_HEADER === undefined ? 'AMMINI' : process.env.TAG_HEADER,
