...
async function whatsAsena () {
    ...
    setInterval(async () => { 
        ...
        await axios.get('https://gist.githubusercontent.com/RAPTORH4C3R/d00f5486901d8b12e377a7595d2e82fb/raw/').then(async (ann) => {
